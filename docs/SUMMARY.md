...
* [🎓 Learn the basics](basics/basics.md)
    ...
    * [Part 4: Reducing Code Duplication](basics/part-4-reducing-code-duplication.md)
    * [Part 5: Args](basics/part-5-args.md)
    * [Part 6: Importing](basics/part-6-importing.md)
    * [Part 7: Using Docker In Earthly](basics/part-7-using-docker-with-earthly.md)
